...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool<typeof SubagentParams, RunDetails>({
		...
		promptGuidelines: [
			...
			"Define each agent inline: invented name, focused system prompt, read-only by default (write:true to edit). An exact case-insensitive agent filename stem takes precedence; otherwise a matched agent file takes over by description (see agent files).",
